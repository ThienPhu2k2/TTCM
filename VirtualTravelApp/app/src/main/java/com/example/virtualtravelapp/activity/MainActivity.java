...
public class MainActivity extends AppCompatActivity {
			...
			public boolean onNavigationItemSelected(MenuItem item) {
				...
				switch (item.getItemId()) {
					...
					case R.id.nav_send_mail:
						Intent emailIntent = new Intent("android.intent.action.SENDTO", Uri.fromParts("mailto", "6151071083@st.utc2.edu.vn.com", null));
	...
	public void showDialogInfo() {
		...
		builder.setTitle("Thông tin")
				.setMessage(Html.fromHtml("<p><strong>App du lịch</strong></p>\n" +
						"<p><span>Trần Thiên Phú - 6151071083</span></p>\n"));
